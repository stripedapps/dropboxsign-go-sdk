...
// checks if the SubFormFieldsPerDocumentHyperlink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubFormFieldsPerDocumentHyperlink{}

// SubFormFieldsPerDocumentHyperlink This class extends `SubFormFieldsPerDocumentBase`.
...
func NewSubFormFieldsPerDocumentHyperlink(type_ string, content string, contentUrl string, documentIndex int32, apiId string, height int32, required bool, signer string, width int32, x int32, y int32) *SubFormFieldsPerDocumentHyperlink {
	this := SubFormFieldsPerDocumentHyperlink{}
...
func (o SubFormFieldsPerDocumentHyperlink) MarshalJSON() ([]byte, error) {
...
func (o SubFormFieldsPerDocumentHyperlink) ToMap() (map[string]interface{}, error) {
...
type NullableSubFormFieldsPerDocumentHyperlink struct {
	value *SubFormFieldsPerDocumentHyperlink
	isSet bool
}

func (v NullableSubFormFieldsPerDocumentHyperlink) Get() *SubFormFieldsPerDocumentHyperlink {
	return v.value
}

func (v *NullableSubFormFieldsPerDocumentHyperlink) Set(val *SubFormFieldsPerDocumentHyperlink) {
	v.value = val
	v.isSet = true
}

func (v NullableSubFormFieldsPerDocumentHyperlink) IsSet() bool {
	return v.isSet
}

func (v *NullableSubFormFieldsPerDocumentHyperlink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubFormFieldsPerDocumentHyperlink(val *SubFormFieldsPerDocumentHyperlink) *NullableSubFormFieldsPerDocumentHyperlink {
	return &NullableSubFormFieldsPerDocumentHyperlink{value: val, isSet: true}
}

func (v NullableSubFormFieldsPerDocumentHyperlink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubFormFieldsPerDocumentHyperlink) UnmarshalJSON(src []byte) error {
	v.isSet = true
