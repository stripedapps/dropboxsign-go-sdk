...
type ApiTemplateCreateEmbeddedRequest struct {
	ctx context.Context
	ApiService *TemplateAPIService
	templateCreateEmbeddedRequest *TemplateCreateEmbeddedRequest
}

func (r ApiTemplateCreateEmbeddedRequest) TemplateCreateEmbeddedRequest(templateCreateEmbeddedRequest TemplateCreateEmbeddedRequest) ApiTemplateCreateEmbeddedRequest {
	r.templateCreateEmbeddedRequest = &templateCreateEmbeddedRequest
	return r
}

func (r ApiTemplateCreateEmbeddedRequest) Execute() (*TemplateCreateEmbeddedResponse, *http.Response, error) {
...
Creates a template that can then be used.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiTemplateCreateEmbeddedRequest
*/
func (a *TemplateAPIService) TemplateCreateEmbedded(ctx context.Context) ApiTemplateCreateEmbeddedRequest {
	return ApiTemplateCreateEmbeddedRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *TemplateAPIService) TemplateCreateEmbeddedExecute(r ApiTemplateCreateEmbeddedRequest) (*TemplateCreateEmbeddedResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
