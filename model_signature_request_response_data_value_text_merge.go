...
// checks if the SignatureRequestResponseDataValueTextMerge type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SignatureRequestResponseDataValueTextMerge{}
...
func (o SignatureRequestResponseDataValueTextMerge) ToMap() (map[string]interface{}, error) {
